        ...
        <channel-uploads :channel="{{ $channel }}" inline-template>
            <div class="col-md-8">
                ...
                <div class="card p-3" v-else>
                    <div class="my-4" v-for="video in videos" v-bind:key="video.name">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="d-flex justify-content-center align-items-center" style="height: 180px; color: #fff; font-size: 18px; background: #808080">
                                    Loading thumbnail...
                                </div>
                            </div>
                            <div class="col-md-4">
